...
sudo dpkg -i ./package/containerd.io.deb
sudo dpkg -i ./package/docker-ce-cli.deb
sudo dpkg -i ./package/docker-ce.deb
...
sudo dpkg -i ./package/libnvidia-container1.deb
sudo dpkg -i ./package/libnvidia-container-tools.deb
sudo dpkg -i ./package/nvidia-container-toolkit.deb
sudo dpkg -i ./package/nvidia-container-runtime.deb
sudo dpkg -i ./package/nvidia-docker2.deb
sudo pkill -SIGHUP dockerd
sudo systemctl restart docker
...
sudo docker load -i ./package/easy_runtime.tar
if [ $? -ne 0 ]; then
    echo "Failed to load easy_runtime"
    exit 1
fi
